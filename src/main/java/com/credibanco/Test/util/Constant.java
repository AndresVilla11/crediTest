...
public class Constant {
    public static final String SECRET_KEY = "LyotNGN0MXY0Y2kwbi1SNGQ0ci1QcjFjMy1QcjB5M2N0MC0xbnQzcm4wLTNuLTg0Y2szbmQtLyo=";
    public static final String PREFIX = "Bearer ";
    public static final String INACTIVO = "inactivo";
    public static final String ACTIVO = "activo";
    public static final String BLOQUEAR = "bloqueado";
